        ...
        <div className="w-11/12 md:ms-12 ms-5 ">
          ...
          <div>
            <div className="flex items-center bg-white text-black font-medium h-24 py-3 px-4 text-center">
              <Link to={'/subTask2'} className="w-2/5 flex justify-center hover:text-gray-600">
                <span>
              ...
              <div className="w-2/5 flex justify-center">
                <Link to={'/subTask2'} className=" w-10 py-1 rounded-lg bg-green-600 transition-transform duration-500 hover:scale-105 ">
                  <FontAwesomeIcon
                    icon={faPen}
